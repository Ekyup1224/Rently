...
/**
 * Application-level failure carrying the HTTP status and a stable machine-readable
 * code that the frontends switch on. Never put user-supplied data in {@code code}.
 */
